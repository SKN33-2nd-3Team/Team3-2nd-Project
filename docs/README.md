...
| [validation_plan.md](validation_plan.md) | 분할·평가·임계값 | 누수 방지, 고정 5-Fold OOF, 무라벨 Test 용도, threshold |
...
| [../reports/training_report.md](../reports/training_report.md) | 인공지능 모델 학습 결과서 | 후보 모델, OOF 비교표, 오류 현황, 모델 저장 |
